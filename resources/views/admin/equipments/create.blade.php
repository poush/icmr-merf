                ...
                <div class="bg-white p-3 rounded-b">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.equipments.store') }}">
                        ...
                        <div class="flex items-stretch mb-3">
                            ...
                            <div class="flex flex-col w-3/4">
                                <select name="category_id" class="block appearance-none w-full bg-white border border-grey-light hover:border-grey px-4 py-2 pr-8 rounded shadow" required>
                                    ...
                                    <option value="{{ $r_value }}" @if(old( 'category_id' ) == $r_value ) selected @endif >{{ $name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="flex items-stretch mb-3">
                            ...
                            <div class="flex flex-col w-3/4">
                                <input id="not_working_since" type="text" class="flex-grow h-8 px-2 border rounded {{ $errors->has('not_working_since') ? 'border-red-dark' : 'border-grey-light' }}" name="not_working_since" value="{{ old('not_working_since') }}">
                        ...
                        <div class="flex items-stretch mb-3">
                            ...
                            <div class="flex flex-col w-3/4">
                                <input id="purchase_date" type="text" class="flex-grow h-8 px-2 border rounded {{ $errors->has('purchase_date') ? 'border-red-dark' : 'border-grey-light' }}" name="purchase_date" value="{{ old('purchase_date') }}">
                        ...
                        <div class="flex items-stretch mb-3">
                            ...
                            <div class="flex flex-col w-3/4">
                                <input id="equipment_age" type="number" class="flex-grow h-8 px-2 border rounded {{ $errors->has('equipment_age') ? 'border-red-dark' : 'border-grey-light' }}" name="equipment_age" value="{{ old('equipment_age') }}" >
                        ...
                        <div class="flex items-stretch mb-3">
                            ...
                            <div class="flex flex-col w-3/4">
                                <input id="source_funding" type="text" class="flex-grow h-8 px-2 border rounded {{ $errors->has('source_funding') ? 'border-red-dark' : 'border-grey-light' }}" name="source_funding" value="{{ old('source_funding') }}" >
                        ...
                        <div class="flex items-stretch mb-3">
                            ...
                            <div class="flex flex-col w-3/4">
                                <input id="state_art" type="text" class="flex-grow h-8 px-2 border rounded {{ $errors->has('state_art') ? 'border-red-dark' : 'border-grey-light' }}" name="state_art" value="{{ old('state_art') }}" >
