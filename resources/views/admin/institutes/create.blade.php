        ...
        <div class="md:w-1/2 md:mx-auto">
            <div class="rounded shadow">
                ...
                <div class="bg-white p-3 rounded-b">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.institutes.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="flex items-stretch mb-3">
                            ...
                            <div class="flex flex-col w-3/4">
                                <input id="city" type="text" class="flex-grow h-8 px-2 border rounded {{ $errors->has('city') ? 'border-red-dark' : 'border-grey-light' }}" name="city" value="{{ old('city') }}" required>
